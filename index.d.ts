 ...
 * ```
 */
export declare class InAppPurchaseOriginal extends IonicNativePlugin {
    /**
    ...
    /**
     * Same as "consime" but for subscriptions, it's needed to consume subscriptions since Play Store Billing V4
     * @param {string} productType
     * @param {string} receipt
     * @param {string} signature
     * @returns {Promise<any>}
     */
    acknowledge(productType: string, receipt: string, signature: string): Promise<any>;
    /**
...
export declare const InAppPurchase: InAppPurchaseOriginal;